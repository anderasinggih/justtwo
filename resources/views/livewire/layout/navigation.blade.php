    ...
    <div class="fixed bottom-3 sm:bottom-8 left-1/2 -translate-x-1/2 z-50 w-[92%] sm:w-auto sm:min-w-[400px] max-w-md" wire:persist="main-nav">
        <nav x-data="{ 
            ...
            <a href="/planner" wire:navigate.hover @click="setPage(1)"
                ...
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2H10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
            </a>
