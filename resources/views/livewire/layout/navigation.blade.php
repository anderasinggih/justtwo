...
<div class="contents">
    ...
    <div class="fixed bottom-1 left-1/2 -translate-x-1/2 z-50 w-[92%] max-w-md" wire:persist="main-nav">
        <nav x-data="{ 
            ...
            {{-- Home --}}
            <a href="/dashboard" wire:navigate @click="setPage(0)"
            ...
            {{-- Timeline --}}
            <a href="/timeline" wire:navigate @click="setPage(1)"
            ...
            {{-- Gallery --}}
            <a href="/gallery" wire:navigate @click="setPage(3)"
            ...
            {{-- Profile --}}
            <a href="/profile" wire:navigate @click="setPage(4)"
