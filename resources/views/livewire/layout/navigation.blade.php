...
<div class="contents">
    ...
    <div class="fixed bottom-1 left-1/2 -translate-x-1/2 z-50 w-[92%] max-w-md" wire:persist="main-nav">
        <nav x-data="{ 
            ...
            {{-- Home --}}
            <a href="{{ route('dashboard', [], false) }}" wire:navigate @click="setPage(0)"
            ...
            {{-- Timeline --}}
            <a href="{{ route('timeline', [], false) }}" wire:navigate @click="setPage(1)"
            ...
            <div class="relative z-10 flex-1 flex justify-center">
                <a href="{{ route('memories.create', [], false) }}" wire:navigate
            ...
            <a href="{{ route('journey', [], false) }}" wire:navigate @click="setPage(3)"
            ...
            {{-- Profile --}}
            <a href="{{ route('profile', [], false) }}" wire:navigate @click="setPage(4)"
