<div class="w-full min-h-screen bg-black text-white relative">
    <style>
        /* Paksa Header Kunci Mati di Viewport */
        .ultimate-sticky-header {
    ...
    <div x-data="{ 
     ...
     @touchend.window="handleDragEnd()">
        ...
        {{-- Ultimate Fixed Header --}}
        <header class="ultimate-sticky-header py-5 px-4" x-show="cols !== 13" x-cloak>
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold tracking-tight text-white drop-shadow-xl">Library</h1>
        ...
        {{-- Content Grid --}}
        <main class="w-full pt-[84px] pb-32">
        ...
        <div x-show="showConfirm" 
             ...
             class="fixed inset-0 z-[99999] flex items-center justify-center px-6 bg-black/80 backdrop-blur-md"
             x-cloak>
